...
bow_pose = user.poses.find_or_create_by(audio_file: 'bow_pose.m4a') { |pose| pose.name = 'bow_pose'; pose.image_file = 'bow_pose.png'; admin_only = false }
childs_pose = user.poses.find_or_create_by(audio_file: 'childs_pose.m4a') { |pose| pose.name = 'childs_pose'; pose.image_file = 'childs_pose.png'; admin_only = false }
cobra = user.poses.find_or_create_by(audio_file: 'cobra.m4a') { |pose| pose.name = 'cobra'; pose.image_file = 'cobra.png'; admin_only = false }
crescent_pose = user.poses.find_or_create_by(audio_file: 'crescent_pose.m4a') { |pose| pose.name = 'crescent_pose'; pose.image_file = 'crescent_pose_left.png'; admin_only = false }
crescent_pose_left = user.poses.find_or_create_by(audio_file: 'crescent_pose_left.m4a') { |pose| pose.name = 'crescent_pose_left'; pose.image_file = 'crescent_pose_left.png'; admin_only = false }
crescent_pose_right = user.poses.find_or_create_by(audio_file: 'crescent_pose_right.m4a') { |pose| pose.name = 'crescent_pose_right'; pose.image_file = 'crescent_pose_right.png'; admin_only = false }
...
eagle_pose = user.poses.find_or_create_by(audio_file: 'eagle_pose.m4a') { |pose| pose.name = 'eagle_pose'; pose.image_file = 'eagle_pose.png'; admin_only = false }
...
half_headstand = user.poses.find_or_create_by(audio_file: 'half_headstand.m4a') { |pose| pose.name = 'half_headstand'; pose.image_file = 'half_headstand'; admin_only = false }
headstand = user.poses.find_or_create_by(audio_file: 'headstand.m4a') { |pose| pose.name = 'headstand'; pose.image_file = 'headstand'; admin_only = false }
...
plow_pose = user.poses.find_or_create_by(audio_file: 'plow_pose.m4a') { |pose| pose.name = 'plow_pose'; pose.image_file = 'plow_pose.png'; admin_only = false }
...
savasana = user.poses.find_or_create_by(audio_file: 'savasana.m4a') { |pose| pose.name = 'savasana'; pose.image_file = 'savasana.png'; admin_only = false }
seated_forward_bend = user.poses.find_or_create_by(audio_file: 'seated_forward_bend.m4a') { |pose| pose.name = 'seated_forward_bend'; pose.image_file = 'seated_forward_bend.png'; admin_only = false }
...
side_plank = user.poses.find_or_create_by(audio_file: 'side_plank.m4a') { |pose| pose.name = 'side_plank'; pose.image_file = 'side_plank_left.png'; admin_only = false }
